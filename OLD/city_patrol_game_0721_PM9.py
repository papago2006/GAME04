...
class TransformationSystem:
    def __init__(self):
        self.word_bank = [
            ...
            {"word": "CULTURE", "hint": "文化 - The customs, arts, and social institutions of a particular nation, people, or group"}
            {"word": "SMALL", "hint": "小的 - Not large in size"}
        ]
        self.timer = 15.0  # 30秒計時器
    ...
    def end_confirmation(self):
        """取消確認，重置計時器"""
        self.confirmation_active = False
        self.timer = 5.0  # 重置計時器
    
    def start_transformation(self):
        self.question_active = False
        self.transformation_active = True
        self.transformation_duration = 5.0
        self.timer = 5.0  # 重置計時器
